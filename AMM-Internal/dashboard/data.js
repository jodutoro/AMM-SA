...
const AMM_DATA = {
  ...
  members: [
    ...
    },
    {
      ...
      setupStatus:     "unknown",
      setupItems:      [],
      blockers:        ["No engagement data available"],
      currentBuilds:   [],
      featureRequests: [],
      platformFriction: [],
      personality:     "Attendance without output. Present at every weekly session. Has not reported wins, builds, blockers, or questions across any recorded session. Pattern suggests either silent struggle or low commitment. Action required: direct outreach before next renewal window to assess status and re-engage.",
      quote:           "—",
      quoteContext:    "",
      skills:          [],
      lastActive:      "2026-04-09"
